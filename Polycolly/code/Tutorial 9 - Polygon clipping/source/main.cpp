...
void PrintString(int x, int y, bool pixelcoords, unsigned int rgba, const char* str, ...)
{
	...
	if (!pixelcoords)
	{
		...
		x *= (int) (font_width  * dbg_world_size / (float) width);
		y *= (int) (font_height * dbg_world_size / (float) height);
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow		("Tutorial 7 – Rigid body dynamics");
